...
var displayMap = function displayMap(locations) {
  var map = new mapboxgl.Map({
    accessToken: 'pk.eyJ1IjoiYmhhcmF0aGNzMjAxMyIsImEiOiJjbGVtZ3FtaHIwOTdhM3FvZmM5OGJucHNzIn0.Z3-McT1lP6LV-OmzYeYVcQ',
    container: 'map',
...
var stripe = Stripe('pk_test_51MjMO9SHVYNIsYE15Ra4HOJuj7WBRFNj9UFpcsuLqB2BbBuxDbKyneXcXyyfn4EpSYeqwGqDy8ztGWIq5Zi1rd4I00gM3wNncL');
...
function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          _context.t0 = _context["catch"](0);
          // console.log(err)
          (0, _alerts.ShowAlerts)('err', _context.t0);
  ...
  return function tourBookings(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.tourBookings = tourBookings;
},{"axios":"../../node_modules/axios/index.js","../js/alerts":"alerts.js"}],"signup.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", (0, _alerts.showAlert)('error', 'password are not same'));
        ...
        case 9:
          _context.prev = 9;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', 'cannot able signup try after some time');
...
var tourBooking = document.getElementById('book-tour'); // DELEGATION

if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations); // console.log('aaaaaaaaaaaaaa',locations)
